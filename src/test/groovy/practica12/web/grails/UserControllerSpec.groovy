...
class UserControllerSpec extends Specification implements ControllerUnitTest<UsuarioController>, DomainUnitTest<Usuario> {
    ...
    void "Test the index action returns the correct model"() {
        given:
        controller.userService = Mock(UsuarioService) {
            1 * list(_) >> []
            1 * count() >> 0
        }
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.userService = Mock(UsuarioService) {
            1 * save(_ as Usuario) >> { Usuario user ->
